...
class _ticket_detail_train_departureState
  ...
  String tujuan = 'SUB';
  String stasiun1 = 'Univers Indonesia (UI)';
  String stasiun2 = 'Univers Pancasila (UP)';
              ...
              Container(
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 6),
                    Container(
                      width: MediaQuery.of(context).size.width - 50 - 37,
                      child: Row(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Container(
                          child: Text(DateFormat.Hm().format(data),
                        ...
                        SizedBox(height: 2),
                        Container(
                          child: Text(DateFormat.MMMd().format(data),
                              style: GoogleFonts.montserrat().copyWith(
                                  fontSize: 10,
